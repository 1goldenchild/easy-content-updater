  ...
  "rolex-numerology": {
    ...
    content: `
      <div class="space-y-6">
        ...
        <div class="relative h-[400px] w-full mb-8 rounded-lg overflow-hidden">
          <img src="/lovable-uploads/841cc51b-3942-436f-a692-be30a0b5b243.png" alt="Luxurious Rolex boutique with emerald green walls and display cases" class="absolute inset-0 w-full h-full object-cover" />
          <div class="absolute inset-0 bg-gradient-to-b from-transparent to-background/80"></div>
        </div>
    ...
    `,
    image: "/lovable-uploads/841cc51b-3942-436f-a692-be30a0b5b243.png",
    date: "March 29, 2024",
    readTime: "8 min read"
  },
