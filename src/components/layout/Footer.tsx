...
const Footer = () => {
  return (
    <footer className="w-full bg-[#1A1A24]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/refund" className="text-blue-500 hover:text-blue-400 transition-colors">
                  Refund Policy
                </Link>
              </li>
              <li>
                <Link to="/support" className="text-blue-500 hover:text-blue-400 transition-colors">
                  Support
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-[#2A2A35] text-white rounded border border-gray-700 focus:outline-none focus:border-blue-500 transition-colors"
            />
          </div>
        </div>
