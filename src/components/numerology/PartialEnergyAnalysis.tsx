...
const PartialEnergyAnalysis = ({ partialEnergy, isVisible }: PartialEnergyAnalysisProps) => {
  ...
  const getPartialEnergyDescription = (number: number): string => {
    const descriptions: { [key: number]: string } = {
      ...
      3: "So you're a Partial 3. 3 is the number of the child, 1 is the masculine number, 2 is the feminine number, and 3 is the childish number. When we say 'oh, you're childish,' it's usually an insult, but in this case, it is not.",
